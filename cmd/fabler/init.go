...
func initAll(conf *conf.Configuration) {
	...
	q0 := model.Question{Title: "How to use the Fabler?", Desc: `{"blocks":[{"key":"9s4bh","text":"How should we use it?","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}`, Type: 0, QuestionProfile: p0}
	q1 := model.Question{Title: "这玩意咋用？", Desc: `{"blocks":[{"key":"bvelr","text":"这个 Fabler 究竟如何使用？","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}`, Type: 0, QuestionProfile: p0}
	q0.Create()
	q1.Create()
